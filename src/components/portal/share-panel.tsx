...
import { Badge, NativeSelect } from "@/components/portal/ui";
...
export function SharePanel({
	...
	return (
		<section className="rounded-xl border border-white/10 p-4">
			...
			<form onSubmit={share} className="mt-4 flex flex-col gap-2">
				<Input
					name="email"
					type="email"
					required
				...
				<div className="flex gap-2">
					<NativeSelect name="access" aria-label="Access" className="flex-1">
